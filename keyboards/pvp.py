...
def get_pvp_battle_keyboard(
    ...
    if force_response:
        ...
        if battlerdan_stage:
            ...
            prefix = "pvp_action_battlerdan_choose" if battlerdan_stage == "choose" else "pvp_action_battlerdan_guess"
    ...
    if action_state.get("can_sword", False):
        rows.append([InlineKeyboardButton(text="⚖️ Золотой меч", callback_data="pvp_action_higuruma_sword")])
